...
declare module 'pdf-lib' {
  export class PDFDocument {
    ...
    static load(data: Uint8Array | ArrayBuffer | string, options?: { ignoreEncryption?: boolean }): Promise<PDFDocument>;
...
declare module 'pdfjs-dist' {
  ...
  export function getDocument(src: { data: Uint8Array } | string): { promise: Promise<PDFDocumentProxy> };
  ...
  export interface PDFPageProxy {
    ...
    render(renderContext: { canvasContext: CanvasRenderingContext2D; viewport: PageViewport }): { promise: Promise<void> };
  }
...
declare module 'jszip' {
  export default class JSZip {
    file(name: string, data: string | Blob | Uint8Array | ArrayBuffer, options?: { base64?: boolean }): this;
    generateAsync(options: { type: 'blob' | 'uint8array' | 'arraybuffer'; compression?: string; compressionOptions?: { level: number } }): Promise<Blob>;

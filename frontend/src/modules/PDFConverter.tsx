...
import { FileText, Upload, Layers, Download, Image, ScanLine } from 'lucide-react';
        ...
        {activeTab === 'files' && (
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">Drag & drop PDFs or images here, or click to browse</p>
            </label>
            <PDFFileList
              files={pdfFiles}

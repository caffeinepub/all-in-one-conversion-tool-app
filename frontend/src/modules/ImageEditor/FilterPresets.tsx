...
const FILTERS = [
  ...
  { id: 'cinematic', label: 'Cinematic', preview: 'contrast(1.2) saturate(0.8) sepia(0.15)' },
  { id: 'cool', label: 'Cool', preview: 'hue-rotate(30deg) saturate(1.2)' },
  { id: 'warm', label: 'Warm', preview: 'hue-rotate(-20deg) saturate(1.3)' },
];

export default function FilterPresets({ currentFilter, onUpdate }: FilterPresetsProps) {
  return (

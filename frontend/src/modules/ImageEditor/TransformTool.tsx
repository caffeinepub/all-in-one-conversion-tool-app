...
export default function TransformTool({ imageState, onUpdate }: TransformToolProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2">
        <Button variant="outline" size="sm" onClick={() => handleRotate(90)} className="gap-2">
          <RotateCw className="w-3.5 h-3.5" />
          Rotate 90°
        </Button>
        <Button variant="outline" size="sm" onClick={() => handleRotate(180)} className="gap-2">
          <RotateCw className="w-3.5 h-3.5" />
          Rotate 180°
        </Button>
        <Button

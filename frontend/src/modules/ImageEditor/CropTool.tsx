    ...
    <div className="space-y-4">
      ...
      {isCropActive && (
        <div className="rounded-md bg-primary/10 border border-primary/30 px-3 py-2 text-xs text-primary text-center">
          Drag the handles on the canvas to adjust the crop region, then click <strong>Apply Crop</strong>.
        </div>
      )}

      <div className="space-y-2">
        <p className="text-xs text-muted-foreground">Quick Aspect Ratio Presets</p>

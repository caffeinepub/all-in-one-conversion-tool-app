import type { ConversionSettings as Settings, OutputFormat, FilterType } from './useImageConversion';
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(v) => onChange({ resizeMode: v as Settings['resizeMode'] })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>

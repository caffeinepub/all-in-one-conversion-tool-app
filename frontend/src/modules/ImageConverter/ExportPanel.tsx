...
import { Download, Archive, CheckCircle, Loader2, AlertCircle, ImageIcon, ChevronLeft } from 'lucide-react';
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <ConvertedThumbnail src={img.convertedDataUrl} alt={img.originalName} />

...
import { Bold, Italic, AlignLeft, AlignCenter, AlignRight, Type, Palette, Sparkles } from 'lucide-react';
        ...
        <div className="space-y-4 pl-1">
          ...
          <div className="glass-card p-3 space-y-3 rounded-lg border border-border/50">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-foreground">Text Background</span>
              <div className="ml-auto flex items-center gap-2">
                ...
                />
                <Label htmlFor="text-bg-enabled" className="text-xs cursor-pointer">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: hexToRgba(textConfig.textBgColor, textConfig.textBgOpacity) }}
                    />
                  </div>
                </div>
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={([v]) => onUpdate({ textBgOpacity: v / 100 })}
                  />
                </div>
              </div>
            )}
          ...
          <div className="glass-card p-3 space-y-3 rounded-lg border border-border/50">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-foreground">Text Shadow</span>
              <div className="ml-auto flex items-center gap-2">
                <Switch
                ...
                />
                <Label htmlFor="text-shadow-enabled" className="text-xs cursor-pointer">
              ...
              <div className="space-y-3 pt-1">
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-xs text-muted-foreground">{textConfig.textShadowBlur}px</span>
                  </div>
                  <Slider
                    min={0}
                    max={20}
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-xs text-muted-foreground">{textConfig.textShadowOffsetX}px</span>
                  </div>
                  <Slider
                    min={-10}
                    max={10}
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-xs text-muted-foreground">{textConfig.textShadowOffsetY}px</span>
                  </div>
                  <Slider
                    min={-10}
                    max={10}

...
export default function RemovalPanel({
  ...
  return (
    <div className="glass-card box-white p-4 space-y-4">
      ...
      {/* Output Mode */}
      <div>
        <p className="section-title">Output Background</p>
      ...
      {outputMode === "color" && (
        <div className="animate-fade-in">
          <label htmlFor="bg-color-input" className="section-title">
            Background Color
          </label>
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-1 ml-auto">
              {["#ffffff", "#000000", "#0000ff", "#00ff00", "#ff0000"].map(
                (c) => (
                  <button
                    type="button"
                    key={c}

      ...
      {files.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted-foreground/60 text-xs mt-1">
            Add PDF or image files to convert
          </p>
        </div>
      ) : (
          ...
          {files.map((file) => {
            ...
            return (
              <div
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter" || e.key === " ") toggleSelect(file.id);
                }}
                role="treeitem"
              ...
              >
                ...
                />
                <div
                  className={`p-1.5 rounded ${file.type === "pdf" ? "bg-red-500/20" : "bg-blue-500/20"}`}
                >
                  {file.type === "pdf" ? (

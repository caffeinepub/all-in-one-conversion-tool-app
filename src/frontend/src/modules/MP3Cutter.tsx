...
export default function MP3Cutter() {
  ...
  const drawWaveform = useCallback(
    (peaks: number[], start: number, end: number, duration: number) => {
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="mm-card p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-300">MP3 Cutter</h2>
            <p className="text-sm text-gray-500">
              Import audio, select a range, and download the cut
            </p>
          </div>
          {waveform && (
            <Button
              ...
              size="icon"
              onClick={handleReset}
              className="ml-auto text-gray-600 hover:text-gray-300 hover:bg-white/10 rounded-xl"
            >
              <X className="w-4 h-4" />
            </Button>
          )}
      ...
      {!waveform && (
        <label
          className="mm-card p-8 text-center cursor-pointer mm-upload-zone block"
          onDrop={handleDrop}
        ...
        >
          ...
          {isLoading ? (
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-gray-400">Decoding audio…</p>
            </div>
          ) : (
            <div className="flex flex-col items-center gap-3">
      ...
      {waveform && (
        <div className="mm-card p-6 space-y-5 animate-slide-up">
          <div className="flex items-center justify-between">
            <p className="text-gray-400 text-sm font-medium truncate max-w-xs">
              {fileName}
            </p>
            <span className="text-gray-500 text-xs">
              Duration: {formatTime(waveform.duration)}
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="mm-card-inner p-3 rounded-xl">
              ...
              <p className="text-gray-400 font-mono text-lg font-semibold">
                {formatTime(endTime)}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button
              ...
              variant="outline"
              className="flex-1 border-white/20 text-gray-400 hover:bg-white/10 hover:text-gray-200 rounded-xl"
            >
              {isPlaying ? (
                <>
